...
${secties}
  ...
  <section class="slot">
    <div class="slot-in">
      ...
      <p style="margin-top:12px">Dat bewijs staat ook machineleesbaar op <a href="/bewijs.json" style="color:var(--cyan)">bewijs.json</a>: elke bewering met haar datum, de precisie van die datum, de bron en de pagina's die erop rusten. Wie citeert, kan de datum meenemen.</p>
    </div>
  </section>
